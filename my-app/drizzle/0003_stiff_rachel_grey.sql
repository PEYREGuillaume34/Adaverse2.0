...
--> statement-breakpoint
ALTER TABLE "students_projects" DROP CONSTRAINT "students_projects_user_id_users_id_fk";
--> statement-breakpoint
...
ALTER TABLE "students_projects" ADD CONSTRAINT "students_projects_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
